import { $t as queueAfterTransactionHook, B as record, C as runWithEndpointContext, D as serializeSignedCookie, E as serializeCookie, Gt as withSpan, I as looseObject, J as decodeProtectedHeader, Jt as ATTR_OPERATION_ID, K as base64Url, Kt as ATTR_CONTEXT, L as number, M as array, N as boolean, O as filterOutputFields, P as email, Qt as getCurrentAdapter, R as object, S as getCurrentAuthContext, T as toResponse, V as string, X as jwtVerify, Xt as safeJSONParse, Y as importJWK, Yt as import_src, Zt as getAuthTables, _ as createAuthMiddleware, a as betterFetch, an as generateId, b as hasRequestState, bn as isProduction, c as applyDefaultAccessTokenExpiry, cn as BetterAuthError, d as findInvalidTrustedProxies, en as runWithAdapter, f as getIp, fn as createLogger, g as createAuthEndpoint, gn as env, h as normalizePathname, i as refreshAccessToken, in as initGetFieldName, j as any, jt as JWTExpired, l as isLoopbackHost, ln as kAPIErrorHeaderSymbol, mn as shouldPublishLog, n as socialProviders, nn as getBetterAuthVersion, on as createRandomStringGenerator, p as deprecate, pn as logger, q as decodeJwt, qt as ATTR_HOOK_TYPE, r as validateAuthorizationCode, rn as initGetModelName, s as createAuthorizationURL, sn as APIError, t as SocialProviderListEnum, tn as runWithTransaction, u as createRateLimitKey, un as BASE_ERROR_CODES, v as isAPIError, w as createRouter$1, x as runWithRequestState, xn as isTest, y as defineRequestState, yn as isDevelopment, yt as encode, z as optional } from "../_libs/@better-auth/core+[...].mjs";
import { a as getOrigin, c as isRequestLike, i as getHost, l as resolveBaseURL, n as PACKAGE_VERSION, o as getProtocol, r as getBaseURL, s as isDynamicBaseURLConfig, t as GENERIC_OAUTH_ERROR_CODES, u as wildcardMatch } from "./error-codes-A_PKSxJv.mjs";
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			"/migrations/0002_cinevo_user_state.sql": _0002_cinevo_user_state_default,
			"/migrations/0003_shared_libraries.sql": _0003_shared_libraries_default,
			"/migrations/0004_playback_library_scope.sql": _0004_playback_library_scope_default
		});
...
//#endregion
export { getSql as i, authConfigured as n, gateIdentityEnabled as r, auth as t };
